                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="pages/contact/aksi/aksi_tambah.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name="pesan" id="exampleInputEmail"
                                        placeholder="pesan">
                                </div>
